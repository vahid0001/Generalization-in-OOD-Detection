...
for m in models:
    ...
    corruptions_augs = os.listdir("CIFAR-100-R/")
    ...
    os.makedirs("CIFAR-100-R_features", exist_ok=True)
    np.save("CIFAR-100-R_features/features_" + m + '_train.npy', train_features)
    del train_features
    ...
    np.save("CIFAR-100-R_features/features_" + m + '_test.npy', test_features)
    del test_features
    torch.cuda.empty_cache()
    gc.collect()
    ...
    for c in corruptions_augs:
        ...
        np.save("CIFAR-100-R_features/features_" + m + '_' + c, corruptions_features)
